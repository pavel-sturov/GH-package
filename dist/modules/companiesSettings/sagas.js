  ...
  return regeneratorRuntime.wrap(function view$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _SagasHelper["default"].defaultView(action, _api.CompaniesSettingsApi.view);
  ...
  return regeneratorRuntime.wrap(function update$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _SagasHelper["default"].defaultUpdate(action, _api.CompaniesSettingsApi.update);
...
var _default = [(0, _effects.takeLatest)(_actionTypes.COMPANIES_SETTINGS_ACTIONS.VIEW, view), (0, _effects.takeLatest)(_actionTypes.COMPANIES_SETTINGS_ACTIONS.UPDATE, update)];
