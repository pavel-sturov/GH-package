  ...
  return regeneratorRuntime.wrap(function create$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _SagasHelper["default"].defaultCreate(action, _api.CategoriesRelationsApi.create);
  ...
  return regeneratorRuntime.wrap(function list$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _SagasHelper["default"].defaultList(action, _api.CategoriesRelationsApi.list);
  ...
  return regeneratorRuntime.wrap(function deleteModel$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _SagasHelper["default"].defaultDelete(action, _api.CategoriesRelationsApi["delete"]);
...
var _default = [(0, _effects.takeLatest)(_actionTypes.CATEGORIES_RELATIONS_ACTIONS.CREATE, create), (0, _effects.takeLatest)(_actionTypes.CATEGORIES_RELATIONS_ACTIONS.LIST, list), (0, _effects.takeLatest)(_actionTypes.CATEGORIES_RELATIONS_ACTIONS.DELETE, deleteModel)];
